...
```
Fish Audio S2 の導入は https://speech.fish.audio/ja/install/ を先に確認し、conda 環境を作成してください。
推論は https://speech.fish.audio/ja/inference/ を参照してください。
```
...
| S2-Flash | — | [fish.audio](https://fish.audio/) | より高速・低遅延なクローズドソースモデル |
