...
> [!IMPORTANT]
> **إشعار الترخيص**
> يتم إصدار هذا المشروع بموجب رخصة **Apache License** ويتم إصدار جميع أوزان النماذج بموجب رخصة **CC-BY-NC-SA-4.0 License**. يرجى الرجوع إلى [LICENSE](../LICENSE) لمزيد من التفاصيل.
...
يسمح Fish Audio S2 للمستخدمين باستخدام اللغة الطبيعية للتحكم في تعبير كل جملة، والمعلومات شبه اللغوية، والعواطف، وخصائص الصوت الأخرى. فبدلاً من مجرد استخدام وسوم قصيرة للتحكم بشكل غامض في أداء النموذج، فإن هذا يحسن بشكل كبير الجودة الشاملة للمحتوى المولد.
